...
( SELECT
  ...
  ( SELECT 0 P, 'ALL' ENV,     ' ' FILE_NAME,          ' ' SECTION,                ' ' PARAMETER_NAME,                          ' ' NOT_1, ' ' MIN_VALUE_1,      ' ' MAX_VALUE_1,         ' ' MIN_VALUE_2,           ' ' MAX_VALUE_2,           -1 MIN_REV, -1 MAX_REV, -1 MIN_VERS, -1 MAX_VERS, '' SAP_NOTE, ' ' AREA, ' 'TYPE FROM DUMMY WHERE 1 = 0 UNION ALL
    ...
    SELECT 1,'MULTI','indexserver.ini','query_mediator','cache_enable',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,21.999,2,2,'2555376','indexserver_crash;scale-out;sql_plan_cache',' ' from DUMMY UNION ALL
SELECT 4,'ALL','indexserver.ini','resource_tracking','service_thread_sampling_monitor_include_passport',' ','no','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2478767','system_view',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','optimize_compression','singleindex_consider_for_compressed_columns',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2516807','indexes;CPU;join_engine',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','joins','disable_aggregate_simplification',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2509750','partitioning',' ' from DUMMY UNION ALL
SELECT 3,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2527538','AMDP;stored_procedure',' ' from DUMMY UNION ALL
SELECT 2,'BW','indexserver.ini','calcengine','ce2qo_enable_boundary_op',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2517443','performance; calc_view;Bex;memory_leak;FEMS;BWoH',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2533823','ESX;RowStore',' ' from DUMMY UNION ALL
SELECT 3,'ALL','indexserver.ini','sqlscript','enable_se_execution_with_gtti_dev',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2527648','sqlscript; wrong_result',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','metadata','ignore_exception_during_auto_migration',' ','on','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,21.999,2,2,'2535589','upgrade;indexserver_crash',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','query_mediator','filtertransport_enable',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2535996','indexserver_crash;olap_engine;optimizer',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','session','fda_enable',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,21.999,2,2,'2534365','indexserver_crash;FDA',' ' from DUMMY UNION ALL
SELECT 1,'ERP','indexserver.ini','sql','plan_cache_size',' ','5368709120','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2523230','BSoH;error_2048;sql_plan_cache',' ' from DUMMY UNION ALL
SELECT 1,'SYSREP','global.ini','system_replication','preload_column_tables',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,21.999,2,2,'2542853','indexserver_crash;system_replication;takeover;preload;delta_data_shipping;upgrade',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','session','fda_enable',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,19.999,2,2,'2547605','indexserver_crash',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','joins','disable_itab_runtime_pruning',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,21.999,2,2,'2553487','wrong_result;sql_plan_cache',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','session','protocol_trace',' ','-- no recommendation --','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,21.999,2,2,'2540710','indexserver_crash;PowerPC;trace',' ' from DUMMY UNION ALL
SELECT 1,'SDA','indexserver.ini','smart_data_access','enable_binary_transfer',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2566685','SDA;virtual_table',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','performance_analyzer','planviz_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,21.999,2,2,'2542972','indexserver_crash;planviz',' ' from DUMMY UNION ALL
SELECT 4,'ALL','topology.ini','/databases','2',' ','-- no recommendation --','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,21.999,2,2,'2554185','MDC;SLD',' ' from DUMMY UNION ALL
SELECT 3,'SDI','dpserver.ini','persistence','receiver_comi_interval_sec',' ','2','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2560056','SDI;data_provisioning',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','calcengine','ce2qo_disable_unfolding',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,21.999,2,2,'2544123','indexserver_crash;calc_engine;optimizer',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','backup','parallel_data_backup_backint_channels',' ','-- no recommendation --','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2579371','indexserver_crash;nameserver_crash;backup,backint',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2581803','indexserver_crash;ESX',' ' from DUMMY UNION ALL
SELECT 2,'SYSREP','nameserver.ini','local_watchdog','interval',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2581373','system_replication;takeover',' ' from DUMMY UNION ALL
SELECT 2,'BW','indexserver.ini','calcengine','disabled_patterns',' ','38','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2100040','BWoH;CPU;performance',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','threads','default_stack_size_kb',' ','2048','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2584287','indexserver_crash',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','threads','worker_stack_size_kb',' ','2048','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2584287','indexserver_crash',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','expensive_statement','internal',' ','-- no recommendation --','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2583885','indexserver_crash;trace',' ' from DUMMY UNION ALL
SELECT 3,'BW','indexserver.ini','calcengine','disabled_patterns',' ','43','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2584492','JDBC;Composite_Provider;calc_engine;OLAP_engine;BWoH',' ' from DUMMY UNION ALL
SELECT 3,'ALL','nameserver.ini','session','max_number_of_sessions_per_partition',' ','2048','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2516320','connection_limit;session',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','execution','compilation_strategy',' ','always','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2570371','Memory_leak;HEX',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','execution','asynchronous_compilation',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2570371','Memory_leak;HEX',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','persistence','savepoint_pre_critical_flush_retry_threshold',' ','<clock tick value>','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2538561','performance',' ' from DUMMY UNION ALL
SELECT 2,'BW','indexserver.ini','parallel','max_lock_retry',' ','60','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2535656','OLAP;BWoH;SCM;lock_manager',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2574281','ESX;RowStore;Upgrade;S/4HANA',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','performance_analyzer','planviz_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2575166','indexserver_crash;planviz',' ' from DUMMY UNION ALL
SELECT 3,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2588119','ESX;attribute_engine',' ' from DUMMY UNION ALL
SELECT 3,'ALL','global.ini','communication','ssl',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2547142','OOM;SSL;encryption',' ' from DUMMY UNION ALL
SELECT 2,'SDA','indexserver.ini','smart_data_access','join_relocation',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2587067','SDA;virtual_table',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','resource_tracking','memory_tracking',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2586437','indexserver_crash;OOM;',' ' from DUMMY UNION ALL
SELECT 2,'SDA','indexserver.ini','smart_data_access','join_relocation',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2585974','SDA;virtual_table;optimizer;Composite_provider',' ' from DUMMY UNION ALL
SELECT 1,'SYSREP','indexserver.ini','persistence','log_segment_size_mb',' ','1024','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2572012','system_replication',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2597818','PlanViz;memory_leak;ESX',' ' from DUMMY UNION ALL
SELECT 1,'SYSREP','indexserver.ini','distribution','systemreplication_protocol_version',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.009,2,2,'2587258','hana_client;system_replication',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','distribution','client_distibution_mode',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.009,2,2,'2591281','JDBC;lock_manager',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','reload_tables',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2598453','indexserver_crash;transaction;MVCC',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','backup','max_log_backup_size',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.009,2,2,'2592954','backup;backint;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','joins','disable_aggregate_simplification',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2583884','attribute_engine;trace',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_execution_count',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_execution_count_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_execution_time',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_execution_time_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_memuse',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_memuse_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_part_id',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_part_id_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_partnum',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_partnum_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_rows',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_rows_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_table_classification',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_table_classification_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_table_size_hosted',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_table_size_hosted_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_table_subclassification',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','balance_by_table_subclassification_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC;scale-out',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','expensive_statement','use_in_memory_tracing',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2608324','trace;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','calcengine','disabled_patterns',' ','23','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2601405','calc_engine;calc_view',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','planningengine','formula_parallel_limit',' ','<large_integer_value>','-- no recommendation --','-- no recommendation --','-- no recommendation --',21,23.999,2,2,'2607741','wrong_result;planning_engine',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2546968','indexserver_crash;ESX;optimizer;signal_11',' ' from DUMMY UNION ALL
SELECT 1,'BW','indexserver.ini','dso','search_realization',' ','DSOSearchUsingSearchAPI','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2613469','BWoH;DSO;indexserver_crash',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','csaccessor','disable_table_consistency_checks',' ','4','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2603049','consistency;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','sqlscript','disable_procedure_flattening',' ','yes','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.009,2,2,'2616478','AMDBP;SQLScript;',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','search','qo_extensive_checks',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.009,2,2,'2616802','indexserver_crash;CPU',' ' from DUMMY UNION ALL
SELECT 3,'ALL','indexserver.ini','sqlscript','typecheck_procedure_input_param',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2457876','calc_engine;calc_view',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','memorymanager','statement_memory_limit',' ','<increase_by_1GB>','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2603589','oom;memory_leak',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','resource_tracking','enable_tracking',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2603589','oom;memory_leak',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','resource_tracking','memory_tracking',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2603589','oom;memory_leak',' ' from DUMMY UNION ALL
SELECT 3,'SDA','indexserver.ini','smart_data_access','remote_conn_idle_timeout’',' ','600','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2578523','SDA;tcp_timeout;connection_limit',' ' from DUMMY UNION ALL
SELECT 2,'BW','indexserver.ini','session','socket_keepalive',' ','on','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2621464','tcp_timeout;BWoH;error_10107;error_10108;network',' ' from DUMMY UNION ALL
SELECT 2,'BW','indexserver.ini','session','tcp_keepalive_time',' ','60','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2621464','tcp_timeout;BWoH;error_10107;error_10108;network',' ' from DUMMY UNION ALL
SELECT 2,'BW','indexserver.ini','session','tcp_keepalive_intvl',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2621464','tcp_timeout;BWoH;error_10107;error_10108;network',' ' from DUMMY UNION ALL
SELECT 2,'BW','indexserver.ini','session','tcp_keepalive_probes',' ','5','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2621464','tcp_timeout;BWoH;error_10107;error_10108;network',' ' from DUMMY UNION ALL
SELECT 4,'SYSREP','global.ini','communication','ssl',' ','systempki','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2618451','SSL;encryption;MDC;system_replication',' ' from DUMMY UNION ALL
SELECT 4,'SYSREP','global.ini','system_replication_communication','enable_ssl',' ','on','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2618451','SSL;encryption;MDC;system_replication',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','session','fda_enable',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2627679','FDA;workprocess;signal_11',' ' from DUMMY UNION ALL
SELECT 3,'SDA','indexserver.ini','smart_data_access','enable_or_to_in',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.009,2,2,'2601496','SDA;virtual_table;ODBC',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','performance_analyzer','planviz_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.019,2,2,'2637828','memory_leak;performance;planviz;trace',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','joins','virtual_vids_bitvector_threshold',' ','1000000000','-- no recommendation --','-- no recommendation --','-- no recommendation --',24.01,24.029,2,2,'2642704','indexserver_crash;partitioning;join_engine',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','delta','use_massupdates',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2632716','indexserver_crash;attribute_engine;inverted_index;',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2639068','ESX;indexserver_crash;signal_6;signal_11',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','performance_analyzer','plan_trace_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2643064','indexserver_crash;trace;planviz;signal_11',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','persistence','non_trans_cch_block_size',' ','134217728','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'1999998','parameter;delta_merge',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','performance_analyzer','planviz_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.029,2,2,'2600030','indexserver_crash;planviz',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','row_engine','bulk_deletion_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.009,2,2,'2647906','indexserver_crash;RowStore;OOM;bulk_load',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','transaction','lock_wait_timeout',' ','5*<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2549013','lock_manager;deadlock;XS_engine',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','cs_equi_cond_update_optimization_batch_size',' ','1000000','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.029,2,2,'2644935','LOB;wrong_result;consistency',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.029,2,2,'2642235','ESX;indexserver_crash;planviz;FDA',' ' from DUMMY UNION ALL
SELECT 3,'ALL','indexserver.ini','persistence','use_helper_threads_for_flush',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',24,24.039,2,2,'2655238','XFS;volume;performance',' ' from DUMMY UNION ALL
SELECT 3,'ALL','nameserver.ini','statisticsserver','active',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2644242','statisticsserver;system_view;upgrade',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','statisticsserver','threadpool',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.049,2,2,'2584388','Memory_leak;',' ' from DUMMY UNION ALL
SELECT 3,'ALL','global.ini','backup','data_backup_buffer_size',' ','1536','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2657261','backup;backint;performance',' ' from DUMMY UNION ALL
SELECT 3,'ALL','global.ini','backup','parallel_data_backup_backint_channels',' ','3','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2657261','backup;backint;performance',' ' from DUMMY UNION ALL
SELECT 3,'SYSREP','global.ini','system_replication','check_secondary_active_status',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2649721','system_replication;lock_manager;system_view',' ' from DUMMY UNION ALL
SELECT 4,'ALL','global.ini','resource_tracking','service_thread_sampling_monitor_enabled',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','thread;monitoring',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','use_cfl_for_esx_expression',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.049,2,2,'2660294','indexserver_crash;ESX;memory_manager',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','hex_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.049,2,2,'2663190','indexserver_crash;HEX;LOB',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','hex_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2653796','indexserver_crash;HEX;memory_manager',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','persistence','recovery_max_load_parallelity',' ','8','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.069,2,2,'2668174','log_segments',' ' from DUMMY UNION ALL
SELECT 4,'ALL','indexserver.ini','session','max_lob_prefetch_size',' ','2147483647','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2408032','LOB;JDBC',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','authentication','last_successful_connect_update_interval',' ','300','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2460123','CPU;lock_manager',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','transaction','global_deadlock_check_timeout_on_lock_waiting',' ','<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2549013','lock_manager;deadlock;XS_engine',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','row_engine','num_of_freepage_distributor',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2577314','PowerPC;RowStore;consistency',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','communication','ssl',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2584253','SSL;encryption',' ' from DUMMY UNION ALL
SELECT 2,'BW','indexserver.ini','calcengine','disabled_patterns',' ','47','-- no recommendation --','-- no recommendation --','-- no recommendation --',21,24.009,2,2,'2605359','BEx;calc_view;calc_engine;BWoH',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sqlscript','enable_internal_statement_caching',' ','no','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2587007','wrong_result;result_cache;SQLScript;TUDF;calc_view',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2613993','wrong_result;XSA;ESX;ODATA',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','persistence','optimized_rowstore_load',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2612205','OOM;Rowstore',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','sql','hex_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.009,2,2,'2615987','Indexes;HEX',' ' from DUMMY UNION ALL
SELECT 2,'ALL','daemon.ini','daemon','terminationtimeout',' ','600000','-- no recommendation --','-- no recommendation --','-- no recommendation --',24,24.019,2,2,'2633077','LOB;GC;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','persistence','disposition_lob_read',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',24,24.019,2,2,'2633077','LOB;GC;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','persistence','disposition_lob_read_small',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',24,24.019,2,2,'2633077','LOB;GC;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','persistence','disposition_lob_write',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',24,24.019,2,2,'2633077','LOB;GC;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','persistence','disposition_lob_write_small',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',24,24.019,2,2,'2633077','LOB;GC;',' ' from DUMMY UNION ALL
SELECT 4,'ALL','indexserver.ini','sqltrace','filesize_limit',' ','2147483648','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.029,2,2,'2629103','trace;',' ' from DUMMY UNION ALL
SELECT 4,'ALL','indexserver.ini','sqltrace','max_files',' ','10','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.029,2,2,'2629103','trace;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','executed_statement','enable_ddl',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.029,2,2,'2627000','migration;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','session','data_format_version',' ','6','7','-- no recommendation --','-- no recommendation --',20,24.029,2,2,'2638379','HANA_client;JDBC;SQLDBC',' ' from DUMMY UNION ALL
SELECT 2,'MULTI','indexserver.ini','transaction','global_deadlock_check_timeout_on_lock_waiting',' ','<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2549013','scale-out;lock_manager;deadlock',' ' from DUMMY UNION ALL
SELECT 2,'MULTI','indexserver.ini','transaction','lock_wait_timeout',' ','5*<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2549013','scale-out;lock_manager;deadlock',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','memoryobjects','heap_preparation_interval',' ','300000000','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.029,2,2,'2652487','indexserver_crash;resource_manager',' ' from DUMMY UNION ALL
SELECT 1,'MULTI','indexserver.ini','search','late_materialization_threshold',' ','-1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2662717','indexserver_crash;scale-out',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','joins','disable_pruning',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.049,2,2,'2666574','wrong_result;join_engine;partitioning;ESH',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','table_consistency_check','max_num_large_jobs',' ','100000','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.049,2,2,'2668851','indexserver_crash;consistency',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','metadata','enable_drop_global_temp_row_in_use',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2503043','RowStore;GTT',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2651830','indexserver_crash;ESX',' ' from DUMMY UNION ALL
SELECT 3,'ALL','indexserver.ini','session','data_format_version',' ','8','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2639764','SQL_round;wrong_result',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','mds','mds_distributed_cache_timeout_ms',' ','2000','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2598662','MDS;performance;scale-out;',' ' from DUMMY UNION ALL
SELECT 3,'ALL','indexserver.ini','calcengine','ce2qo_disable_unfolding',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2222200','network;calc_engine;calc_view',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','performance_analyzer','planviz_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2673349','indexserver_crash;optimizer;signal_11;planviz',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','memoryobjects','unused_retention_period',' ','0','3600','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','performance;unload;memory_management',' ' from DUMMY UNION ALL
SELECT 2,'BW','indexserver.ini','session','idle_connection_timeout',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2621464','tcp_timeout;BWoH;error_10107;error_10108;network',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','global','pa_count_distinct_threshold',' ','4096','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2632776','Data_aging;memory_leak',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','indexing','enable_lazy_row_locks',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.049,2,2,'2665390','lock_manager;',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2651830','indexserver_crash;ESX',' ' from DUMMY UNION ALL
SELECT 3,'SDI','indexserver.ini','dataprovisioning','applierRetryUniqueConstraintViolationWithUpsert',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2679343','SDI;flowgraph;data_provisioning',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','multidb','systemdb_reserved_memory',' ','-- no recommendation --','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.029,2,2,'2685802','MDC;nameserver_crash',' ' from DUMMY UNION ALL
SELECT 1,'BW','indexserver.ini','query_mediator','cache_enable',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.059,2,2,'2686900','indexserver_crash;attribute_engine;BWoH;SCM;Cube',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.049,2,2,'2684865','indexserver_crash;XSA;signal_11;ESX',' ' from DUMMY UNION ALL
SELECT 4,'ALL','indexserver.ini','trace','sqlsession',' ','fatal','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.049,2,2,'2666338','SSL;encryption;session;trace;SQLDBC',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','joins','trace_inputs_of_failed_pop',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.049,2,2,'2673798','indexserver_crash;Join_engine;optimizer',' ' from DUMMY UNION ALL
SELECT 1,'MULTI','indexserver.ini','distribution','client_distribution_mode',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.059,2,2,'2686498','wrong_result;scale-out',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','calcengine','disabled_patterns',' ','6','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2683989','wrong_result;calc_view',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',24,24.039,2,2,'2692378','ESX',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','businessDB','strict_rounding_for_emu_conversion',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.059,2,2,'2679900','wrong_result;SQL_Round;Currency_Conversion',' ' from DUMMY UNION ALL
SELECT 2,'MULTI','indexserver.ini','distribution','implicit_xa_session',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.059,2,2,'2691896','scale-out;DML',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.059,2,2,'2696126','indexserver_crash;ESX',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2678486','indexserver_crash;ESX',' ' from DUMMY UNION ALL
SELECT 1,'SDA','indexserver.ini','smart_data_access','odbc_adapters_in_scriptserver',' ','mssql','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2348834','indexserver_crash;SDA',' ' from DUMMY UNION ALL
SELECT 3,'ALL','indexserver.ini','query_mediator','local_group_bys_max_table_sets_per_host',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2704926','indexes;OLAP',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','trace','stream',' ','fatal','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.069,2,2,'2709843','indexserver_crash;signal_11;network',' ' from DUMMY UNION ALL
SELECT 1,'BW','indexserver.ini','bw_flattenscenario','delete_dest_f_table',' ','no','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.059,2,2,'2701165','indexserver_crash;BWoH;OLAP_Engine',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','sql','hex_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.069,2,2,'2704539','HEX',' ' from DUMMY UNION ALL
SELECT 2,'SDI','indexserver.ini','dataprovisioning','appliermaxrowsstagingtable',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2710286','SDI;data_provisioning;flowgraph;performance',' ' from DUMMY UNION ALL
SELECT 2,'SDI','dpserver.ini','persistence','distributor_commit_interval_sec',' ','300','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2710286','SDI;data_provisioning;flowgraph;performance',' ' from DUMMY UNION ALL
SELECT 2,'SDI','dpserver.ini','persistence','receiver_commit_interval_sec',' ','2','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2710286','SDI;data_provisioning;flowgraph;performance',' ' from DUMMY UNION ALL
