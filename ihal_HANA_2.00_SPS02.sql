...
SELECT 'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2527538','AMDP',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','series','series_column_lrle_compression_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2549632','compression_LRLE',' ' from DUMMY UNION ALL
...
SELECT 'SDI','dpserver.ini','persistency','receiver_comi_interval_sec',' ','2','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2560056','SDI',' ' from DUMMY UNION ALL
...
SELECT 'ALL','global.ini','backup','parallel_data_backup_backint_channels',' ','-- no recommendation --','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2579371','indexserver_crash;nameserver_crash;backup,backint',' ' from DUMMY UNION ALL
...
SELECT 'BW','indexserver.ini','calcengine','disable_patterns',' ','38','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2100040','BWoH;CPU;performance',' ' from DUMMY UNION ALL
...
SELECT 'ALL','global.ini','expensive_statement','internal',' ','-- no recommendation --','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2583885','indexserver_crash;trace',' ' from DUMMY UNION ALL
...
SELECT 'ALL','global.ini','persistence','savepoint_pre_critical_flush_retry_threshold',' ','<clock tick value>','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,21.999,2,2,'2538561','performance',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2588119','ESX;attribute_engine',' ' from DUMMY UNION ALL
SELECT 'ALL','global.ini','communication','SSL',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2547142','OOM;SSL;encryption',' ' from DUMMY UNION ALL
SELECT 'SDA','indexserver.ini','smart_data_access','join_relocation',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2587067','SDA;virtual_table',' ' from DUMMY UNION ALL
...
SELECT 'SDA','indexserver.ini','smart_data_access','join_relocation',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2585974','SDA;virtual_table;optimizer;Composite_provider',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2597818','PlanViz;memory_leak;ESX',' ' from DUMMY UNION ALL
SELECT 'SYSREP','nameserver.ini','distribution','systemreplication_protocol_version',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2587258','system_replication;HANA_Client',' ' from DUMMY UNION ALL
   SELECT 'ALL','indexserver.ini','distribution','client_distibution_mode',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2591281','JDBC;lock_manager',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','table_placement','balance_by_execution_count',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_execution_count_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_execution_time',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_execution_time_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_memuse',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_memuse_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_part_id',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_part_id_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_partnum',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_partnum_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_rows',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_rows_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_table_classification',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_table_classification_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_table_size_hosted',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_table_size_hosted_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_table_subclassification',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','table_placement','balance_by_table_subclassification_weight',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','parameter;redistribution;MDC',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,23.999,2,2,'2546968','indexserver_crash;ESX;optimizer;',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','search','qo_extensive_checks',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2616802','indexserver_crash;CPU',' ' from DUMMY UNION ALL
...
SELECT 'ALL','global.ini','communication','ssl',' ','systempki','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2618451','SSL;encryption;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','global.ini','system_replication_communication','enable_ssl',' ','on','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2618451','SSL;encryption;MDC',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','joins','virtual_vids_bitvector_threshold'',' ','1000000000','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2642704','indexserver_crash;partitioning;join_engine',' ' from DUMMY UNION ALL
