...
SELECT 'ALL','indexserver.ini','detla','use_massupdates',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2632716','indexserver_crash;attribute_engine;inverted_index;',' ' from DUMMY UNION ALL
