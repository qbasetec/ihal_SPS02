...
SELECT 3,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,20.999,2,2,'2527538','AMDP;stored_procedure;SQLscript',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','indexserver.ini','sqlscript','disable_procedure_flattening',' ','yes','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.009,2,2,'2616478','AMDP;SQLScript;stored_procedure',' ' from DUMMY UNION ALL
...
SELECT 1,'SYSREP','indexserver.ini','distribution','systemreplication_protocol_version',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.009,2,2,'2587258','hana_client;system_replication',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','session','fda_enable',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2627679','FDA;workprocess;signal_11',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','global.ini','performance_analyzer','plan_trace_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2643064','indexserver_crash;trace;planviz;signal_11',' ' from DUMMY UNION ALL
...
SELECT 3,'ALL','indexserver.ini','persistence','use_helper_threads_for_flush',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',24,-1,2,2,'2655238','XFS;volume;performance',' ' from DUMMY UNION ALL
...
SELECT 3,'SYSREP','global.ini','system_replication','check_secondary_active_status',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2649721','system_replication;lock_manager;system_view',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','indexserver.ini','calcengine','enforce_bigint_counters',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.029,2,2,'2648134','calc_view;calc_engine;attribute_engine',' ' from DUMMY UNION ALL
SELECT 1,'MULTI','indexserver.ini','search','late_materialization_threshold',' ','-1','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2662717','indexserver_crash;scale-out;late_materialization',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','hex_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2663190','indexserver_crash;HEX;LOB',' ' from DUMMY UNION ALL
