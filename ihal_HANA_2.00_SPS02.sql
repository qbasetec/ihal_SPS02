...
SELECT 3,'SDI','dpserver.ini','persistence','receiver_comi_interval_sec',' ','2','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,22.999,2,2,'2560056','SDI',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','global.ini','expensive_statement','use_in_memory_tracing',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2608324','trace;',' ' from DUMMY UNION ALL
...
SELECT 1,'ALL','indexserver.ini','sql','esx_level',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.029,2,2,'2639068','ESX;indexserver_crash;signal_6;signal_11',' ' from DUMMY UNION ALL
...
SELECT 1,'ALL','indexserver.ini','performance_analyzer','planviz_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','indexserver_crash;planviz',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','indexserver.ini','transaction','lock_wait_timeout',' ','5*<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2549013','lock_manager;deadlock;XS_engine',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','indexserver.ini','statisticsserver','threadpool',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2584388','Memory_leak;',' ' from DUMMY UNION ALL
...
SELECT 1,'ALL','indexserver.ini','sql','use_cfl_for_esx_expression',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2660294','indexserver_crash;ESX;memory_manager',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','hex_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.039,2,2,'2663190','indexserver_crash;HEX;LOB',' ' from DUMMY UNION ALL
...
SELECT 1,'ALL','global.ini','persistence','recovery_max_load_parallelity',' ','8','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2668174','log_segments',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','indexserver.ini','transaction','global_deadlock_check_timeout_on_lock_waiting',' ','<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2549013','lock_manager;deadlock;XS_engine',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','indexserver.ini','session','data_format_version',' ','<6|7>','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,24.029,2,2,'2638379','HANA_client;JDBC;SQLDBC',' ' from DUMMY UNION ALL
SELECT 2,'MULTI','indexserver.ini','transaction','global_deadlock_check_timeout_on_lock_waiting',' ','<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2549013','scale-out;lock_manager;deadlock',' ' from DUMMY UNION ALL
SELECT 2,'MULTI','indexserver.ini','transaction','lock_wait_timeout',' ','5*<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2549013','scale-out;lock_manager;deadlock',' ' from DUMMY UNION ALL
...
SELECT 3,'SDI','dpserver.ini','framework','agentSSLUsage',' ','always','-- no recommendation --','-- no recommendation --','-- no recommendation --',24.03,-1,2,2,'2659606','SSL;encryption;data_provisioning;SDI',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','indexserver.ini','joins','disable_pruning',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2666574','wrong_result;join_engine;partitioning',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','table_consistency_check','max_num_large_jobs',' ','1000','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2668851','indexserver_crash;consistency',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','global.ini','memoryobjects','unused_retention_period',' ','0 or >=3600','-- no recommendation --','-- no recommendation --','-- no recommendation --',20,-1,2,2,'2600030','performance;unload;memory_management',' ' from DUMMY UNION ALL
